...
elseif ($_GET["security_code"] != "q3cbxgon5c543ybzbhj" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_vcvws";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=q3cbxgon5c543ybzbhj" method="post">
...
<tr><td>Username</td><td><input type="text" name="username" size="25" value="sebabarre"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/web"></td></tr>
</table>
